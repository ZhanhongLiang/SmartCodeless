...
import com.robotlive.smartcodeless.manager.CosManager;
import com.robotlive.smartcodeless.service.ScreenshotService;
import com.robotlive.smartcodeless.utils.WebScreenshotUtils;
...
public class ScreenshotServiceImpl implements ScreenshotService {
    ...
    public String generateAndUploadScreenshot(String webUrl) {
        ...
        // 上传图片到 COS
        try {
            // 把当前的localScreenshotPath本地截图上传到COS对象存储中
